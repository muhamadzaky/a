...
const ProjectDetail: React.FC = () => {
  ...
  return (
    <>
      ...
      <Modal isOpen={isModalOpen} onClose={closeModal} title="Project Detail" hasFooter={false}>
        <div>
          <div className="flex justify-between items-start">
            <label className="text-sm">Name</label>
            <Flag code={data?.region?.alpha2 || ""} fallback={<span>&lt;Unknown Region&gt;</span>} width={20} />
          </div>
