...
const GenerateCV = () => {
        ...
        content: [
            ...
            },
            {
                ul: [
                    ...
                    {
                        text: [
                            { text: "Integrate GraphQL ", bold: true },
                            "alongside the use of RESTful APIs.",
                        ],
                    },
                    {
                        text: [
    ...
    <div className="flex justify-center mt-5">
            <Button variant="ghost" outline onClick={() => pdfMake.createPdf(dd).download('Muhamad Zaky CV.pdf')}>
                Download CV
            </Button>
        </div>
    );
